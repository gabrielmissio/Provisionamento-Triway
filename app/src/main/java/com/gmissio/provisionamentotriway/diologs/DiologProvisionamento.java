...
public class DiologProvisionamento extends AppCompatDialogFragment {
        ...
        builder.setView(view)
                ...
                .setPositiveButton("CONFIRMAR", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        listener.aplicarTexts(username, password);
                    }
                });
    ...
    public interface DiologProvisionamentoListener{
        void aplicarTexts(String username, String password);
    }
}
